...
SECRET_KEY = 'django-insecure-5(868o_4s8c-uff(39z*m35&#20_cnzrdmh)5z*9vn+d2%tw()'
...
LOGIN_URL = 'login_function'  # URL to redirect to if user isn't logged in
LOGIN_REDIRECT_URL = 'dashboard'   # Where to redirect after successful login
LOGOUT_REDIRECT_URL = 'login_function'  # Where to redirect after logout